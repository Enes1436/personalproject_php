      ...
      foreach ($features as $f): ?>
        <div class="col-md-6 col-lg-3 fade-up">
          <div class="feature">
            ...
            <h5 class="fw-bold"><?= e($f[1]) ?></h5>
            <p class="text-secondary mb-0"><?= e($f[2]) ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
                ...
                <div class="col-md-4">
                  <div class="car-card">
                    <div class="img">
                      ...
                      <img src="<?= e(car_image_url($car['image'])) ?>" alt="<?= e($car['brand'].' '.$car['model']) ?>">
                    </div>
                    <div class="body">
                      <h5><?= e($car['brand'].' '.$car['model']) ?></h5>
                      <small class="text-secondary"><?= e($car['year']) ?> · <?= e($car['transmission']) ?></small>
                      <div class="meta">
                      ...
                      <div class="d-flex justify-content-between align-items-center mt-auto">
                        ...
                        <a href="car.php?id=<?= (int)$car['id'] ?>" class="btn btn-primary-grad btn-sm">Book</a>
                      </div>
                    </div>
                  </div>
                </div>
